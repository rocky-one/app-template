...
function Demo(): JSX.Element {
  ...
  return <div className={styles['car-container']}>
    <div className={styles.tools}>
      ...
      <Button onClick={() => {manageInstance?.animationManager?.openCarLight();}} type='primary'>开车灯</Button> <br />
      <Button onClick={() => {manageInstance?.animationManager?.closeCarLight();}} type='primary'>关车灯</Button> <br />
      <Button onClick={() => {manageInstance?.animationManager?.openDoors();}} type='primary'>开车门</Button> <br />
      <Button onClick={() => {manageInstance?.animationManager?.closeDoors();}} type='primary'>关车门</Button> <br />
      <div className={styles['car-color']}>换色<ColorPicker onChange={(_val, color) => {
        manageInstance?.animationManager?.setCarColor(color);
      }} /></div> <br />
    </div>
